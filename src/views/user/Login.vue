    ...
    >
      ...
      >
        ...
        <a-tab-pane key="tab2" tab="手机号登陆">
          <a-form-item>
            <a-input v-decorator="['mobile', {rules: [{ required: true, pattern: /^1[34578]\d{9}$/, message: '请输入正确的手机号' }], validateTrigger: 'change'}]" size="large" type="text" placeholder="手机号">
      ...
      <a-form-item>
        ...
        <!-- <router-link
          ...
          style="float: right;"
        >忘记密码</router-link> -->
        <router-link class="register" style="float: right;" :to="{ name: 'register' }">
          注册账户
        </router-link>
      </a-form-item>
