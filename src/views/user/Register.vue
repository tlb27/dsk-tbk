  ...
  <div class="main user-layout-register">
    ...
    <a-form id="formRegister" ref="formRegister" :auto-form-create="(form)=>{this.form = form}">
      <a-form-item
        ...
        :field-decorator-options="{rules: [{ required: true,message: '请输入用户名' }], validateTrigger: ['change', 'blur']}"
      >
      ...
      <a-popover placement="rightTop" trigger="click" :visible="state.passwordLevelChecked">
        ...
        >
          <a-input size="large" type="password" autocomplete="false" placeholder="至少6位密码，区分大小写" @click="handlePasswordInputClick" />
        </a-form-item>
      </a-popover>
      ...
      <a-form-item
        field-decorator-id="team"
        :field-decorator-options="{rules: [{ required: true, message: '你的团队不能为空' }], validateTrigger: ['change', 'blur']}"
      >
        <a-input size="large" type="text" placeholder="请输入你的团队" />
      </a-form-item>
      <a-form-item
      ...
      <a-row :gutter="16">
        <a-col class="gutter-row" :span="16">
          <a-form-item
            field-decorator-id="verification"
    ...
    handleSubmit() {
      this.form.validateFields((err, values) => {
        if (!err) {
          ...
          console.log(data)
          this.axios.post('/admin/register', data).then(res => {
            if (res.msg == '创建成功，请联系管理员激活该账户') {
